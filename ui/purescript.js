...
var traverseWithIndex = function (dictApplicative) {
    return function (f) {
        return function ($310) {
            return Data_Traversable.sequence(Data_Traversable.traversableArray)(dictApplicative)(Data_Array.mapWithIndex(f)($310));
        };
    };
};
...
var setupBuildQueuer = function (_pkgName) {
    return Control_Monad_Eff_Exception_Unsafe.unsafeThrow("setupBuildQueuer");
};
...
var selectFirst = Control_Bind.composeKleisliFlipped(Control_Monad_Eff.bindEff)(function ($311) {
    return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Array.head)(Control_Monad_Eff_JQuery.toArray($311));
...
var newMajor = function (ma) {
    return function (b) {
        ...
        throw new Error("Failed pattern match at Main line 594, column 17 - line 597, column 63: " + [ ma.constructor.name ]);
    };
};
var newMinor = function (ma) {
    return function (b) {
        ...
        throw new Error("Failed pattern match at Main line 600, column 17 - line 603, column 67: " + [ ma.constructor.name ]);
    };
};
    ...
    return function (packageVersion) {
        return function __do() {
            ...
            (function () {
                ...
                throw new Error("Failed pattern match at Main line 878, column 3 - line 880, column 39: " + [ v.constructor.name ]);
            })()();
            return Data_Unit.unit;
        };
    };
    ...
    return function (versionName) {
        return function (prevVersionName) {
            ...
            return Uri.newUri((function () {
                ...
                throw new Error("Failed pattern match at Main line 607, column 16 - line 609, column 52: " + [ prevVersionName.constructor.name ]);
            })());
        };
    };
};
var hasReportForPackage = function (st) {
    return function (pn) {
        var $142 = Data_Foldable.find(Data_Foldable.foldableArray)(function (v) {
            return v.name === pn;
        })(st.allPackagesMore);
        ...
        if ($142 instanceof Data_Maybe.Just) {
            return Data_Maybe.isJust($142.value0.report);
        };
        throw new Error("Failed pattern match at Main line 342, column 3 - line 344, column 32: " + [ $142.constructor.name ]);
    };
};
    ...
    return function (pkg) {
        ...
        return function __do() {
            ...
            return Data_Function.flip(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_List_Types.foldableList))(Data_List.reverse(Data_List.range(0)(rows - 1 | 0)))(function (row) {
                ...
                throw new Error("Failed pattern match at Main line 519, column 5 - line 588, column 22: " + [ mv.constructor.name ]);
            })();
        };
    };
};
                            ...
                            if (tagIndex instanceof Data_Maybe.Nothing) {
                                return function __do() {
                                    Control_Monad_ST.writeSTRef(state)((function () {
                                        var $201 = {};
                                        for (var $202 in v2) {
                                            if ({}.hasOwnProperty.call(v2, $202)) {
                                                $201[$202] = v2[$202];
                                            };
                                        };
                                        $201.activeTagFilters = Data_Array.cons(v1)(v2.activeTagFilters);
                                        return $201;
                                    })())();
                            ...
                            if (tagIndex instanceof Data_Maybe.Just) {
                                return function __do() {
                                    Control_Monad_ST.writeSTRef(state)((function () {
                                        var $204 = {};
                                        for (var $205 in v2) {
                                            if ({}.hasOwnProperty.call(v2, $205)) {
                                                $204[$205] = v2[$205];
                                            };
                                        };
                                        $204.activeTagFilters = Data_Array["delete"](Data_Eq.eqString)(v1)(v2.activeTagFilters);
                                        return $204;
                                    })())();
            ...
            return function (sr) {
                return function __do() {
                    (function () {
                        ...
                        throw new Error("Failed pattern match at Main line 767, column 7 - line 777, column 16: " + [ sr.resultA.constructor.name ]);
                    })()();
                    return Data_Unit.unit;
                };
            };
            ...
            return function (sr) {
                return function __do() {
                    (function () {
                        ...
                        throw new Error("Failed pattern match at Main line 729, column 7 - line 737, column 16: " + [ sr.resultA.constructor.name ]);
                    })()();
                    return Data_Unit.unit;
                };
            };
                                    ...
                                    return function (versionResult) {
                                        return function __do() {
                                            ...
                                            var v9 = (function () {
                                                ...
                                                throw new Error("Failed pattern match at Main line 648, column 13 - line 654, column 27: " + [ v8.constructor.name ]);
                                            })()();
                                            ...
                                            (function () {
                                                ...
                                                throw new Error("Failed pattern match at Main line 662, column 7 - line 683, column 39: " + [ versionResult.result.constructor.name ]);
                                            })()();
                                            return Data_Unit.unit;
                                        };
                                    };
        ...
        return function (pr) {
            return function __do() {
                ...
                (function () {
                    ...
                    throw new Error("Failed pattern match at Main line 460, column 3 - line 475, column 1: " + [ pr.constructor.name ]);
                })()();
                cleanupTabs();
    ...
    return function (state) {
        return function (pkgName) {
            ...
            return function __do() {
                ...
                Data_Unit.unit;
                var $276 = Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(pkgName)(v.allPackages);
                if ($276) {
                ...
                throw new Error("Failed pattern match at Main line 429, column 3 - line 436, column 41: " + [ $276.constructor.name ]);
            };
        };
    };
};
                ...
                return function (isPopping) {
                    return function __do() {
                        ...
                        return Control_Applicative.unless(Control_Monad_Eff.applicativeEff)(!force && Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqString))(Uri.path(uri_))(Uri.path(v)))(function __do() {
                            var v1 = (function () {
                                var $280 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqString))(Uri.path(uri_))(new Data_Maybe.Just("/"));
                                if ($280) {
                                    return function __do() {
                                        renderHome();
                                        return {
                                ...
                                if (!$280) {
                                    var $281 = MatrixApi.getVersionedPackageName(uri_);
                                    if ($281 instanceof Data_Maybe.Just) {
                                        var title = $281.value0.packageName + " - package";
                                        var uriForPackage = packageUri($281.value0.packageName)(Data_Maybe.Nothing.value);
                                        return function __do() {
                                            selectedPackage(api)(state)($281.value0.packageName)();
                                            return {
                                                title: new Data_Maybe.Just(title), 
                                                packageName: new Data_Maybe.Just($281.value0.packageName)
                                            };
                                        };
                                    };
                                    if ($281 instanceof Data_Maybe.Nothing) {
                                        var $283 = MatrixApi.getPackageName(uri_);
                                        if ($283 instanceof Data_Maybe.Just) {
                                            var title = $283.value0 + " - package";
                                            var uriForPackage = packageUri($283.value0)(Data_Maybe.Nothing.value);
                                            return function __do() {
                                                selectedPackage(api)(state)($283.value0)();
                                                return {
                                                    title: new Data_Maybe.Just(title), 
                                                    packageName: new Data_Maybe.Just($283.value0)
                                                };
                                            };
                                        };
                                        if ($283 instanceof Data_Maybe.Nothing) {
                                            var $285 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqString))(Uri.path(uri_))(new Data_Maybe.Just("/latest"));
                                            if ($285) {
                                                return function __do() {
                                                    renderLatest(state)();
                                            ...
                                            if (!$285) {
                                                var $286 = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_Regex.match(regex$prime("^/user/([^/]+)")(Data_String_Regex_Flags.noFlags)))(Uri.path(uri_));
                                                if ($286 instanceof Data_Maybe.Just && $286.value0 instanceof Data_Maybe.Just) {
                                                    var $287 = Data_Array.head($286.value0.value0);
                                                    if ($287 instanceof Data_Maybe.Just && $287.value0 instanceof Data_Maybe.Just) {
                                                        return function __do() {
                                                            renderUser($287.value0.value0)();
                                                            return justTitle($287.value0.value0 + "- users");
                                                        };
                                                    };
                                                    return throwLog("TODO5")($287);
                                                };
                                                var $292 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqString))(Uri.path(uri_))(new Data_Maybe.Just("/packages"));
                                                if ($292) {
                                                    return function __do() {
                                                ...
                                                throw new Error("Failed pattern match at Main line 157, column 23 - line 164, column 5: " + [ $292.constructor.name ]);
                                            };
                                            throw new Error("Failed pattern match at Main line 144, column 17 - line 164, column 5: " + [ $285.constructor.name ]);
                                        };
                                        throw new Error("Failed pattern match at Main line 137, column 13 - line 164, column 5: " + [ $283.constructor.name ]);
                                    };
                                    throw new Error("Failed pattern match at Main line 127, column 9 - line 164, column 5: " + [ $281.constructor.name ]);
                                };
                                throw new Error("Failed pattern match at Main line 122, column 7 - line 164, column 5: " + [ $280.constructor.name ]);
                            })()();
                    ...
                    return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                        ...
                        return MiscFFI.delegate2(MiscFFI.selectableJQuery)(MiscFFI.selectableString)(v)("a")("click")(function (e) {
                            return function __do() {
                                ...
                                throw new Error("Failed pattern match at Main line 95, column 7 - line 113, column 50: " + [ $304.constructor.name ]);
                            };
                        })();
                    });
                });
...
var stringyErr = function (err) {
    return function (s) {
        return function ($8) {
            return err(Data_Function["const"](Control_Monad_Eff_Exception.error(s))($8));
        };
    };
};
...
var packageList = function (api) {
    return function (range) {
        var packageMetaFromFFI = function (p) {
            var $2 = {};
            for (var $3 in p) {
                if ({}.hasOwnProperty.call(p, $3)) {
                    $2[$3] = p[$3];
                };
            };
            $2.report = MiscFFI.undefine(p.report);
            return $2;
        };
        return Control_Monad_Aff.makeAff(function (err) {
            return function (succ) {
                return $foreign.packageList_(api, range, function (pms) {
                    return succ((function () {
                        var $5 = {};
                        for (var $6 in pms) {
                            if ({}.hasOwnProperty.call(pms, $6)) {
                                $5[$6] = pms[$6];
                            };
                        };
                        $5.items = Data_Functor.map(Data_Functor.functorArray)(packageMetaFromFFI)(pms.items);
                        return $5;
                    })());
...
var getVersionedPackageName = function ($9) {
    return Data_Nullable.toMaybe($foreign.getVersionedPackageName_($9));
};
var getPackageName = function ($10) {
    return Data_Nullable.toMaybe($foreign.getPackageName_($10));
};
module.exports = {
